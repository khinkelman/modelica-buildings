...
//protected
  ...
  final parameter Modelica.SIunits.Temperature TSte_nominal=
    Medium_b.saturationTemperature(pSte_nominal) "Nominal steam temperature";
  final parameter Modelica.SIunits.SpecificEnthalpy dhVap=
    Medium_b.enthalpyOfVaporization(
      Medium_b.saturationState(pSte_nominal)) "Change in enthalpy";
