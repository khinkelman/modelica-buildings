...
model PartialSteamBoiler
  ...
  parameter Modelica.SIunits.AbsolutePressure pBoi_nominal
    ...
    annotation(Dialog(group = "Nominal condition"));
  parameter Modelica.SIunits.Temperature TOut_nominal = Medium_b.saturationTemperature(pBoi_nominal)
  ...
  Modelica.Blocks.Interfaces.RealOutput T(
    ...
    final unit = "K",
    displayUnit = "degC",
    min=0) "Temperature of fluid in boiler volume"
  ...
  Buildings.Fluid.Movers.FlowControlled_dp dpCon(
...
protected
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo(redeclare package Medium = Medium_a)
    "Measured mass flow rate"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  Modelica.Blocks.Sources.RealExpression dpSet(y=pBoi_nominal - 101325)
    "Setpoint pressure change"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort temSen_in(redeclare package Medium = Medium_a,
      m_flow_nominal=m_flow_nominal) "Inflowing temperature sensor"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort temSen_out(redeclare package
      Medium =                                                                     Medium_b,
