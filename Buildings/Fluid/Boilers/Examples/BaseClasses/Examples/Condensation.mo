...
model Condensation
  ...
  Buildings.Fluid.Boilers.Examples.BaseClasses.Condensation con(
  ...
  Modelica.Blocks.Sources.Constant pIn(k=pSte)
    "Steam pressure"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Boilers/Examples/BaseClasses/Examples/Condensation.mos"
        "Simulate and plot"));
end Condensation;
