...
model SteamBoilerSimple1Loop_BS2021
  "Closed loop example of steam boiler system with a single building load"
...
//                   dp={2*dp_nominal,dp_nominal,0}));
  ...
  Modelica.Blocks.Math.Gain mCal_flow(k=1/hfg)
  ...
  Modelica.Blocks.Sources.TimeTable y(table=[0,0.01; 1800,1; 2000,1; 2400,0.2; 2600,
        0.2; 3600,0.9])
    annotation (Placement(transformation(extent={{-140,-20},{-120,0}})));
  Modelica.Blocks.Sources.TimeTable y2(table=[0,0.01; 1200,0.2; 1500,0.8; 2500,0.8;
        3000,0.3; 3600,0.3])
...
equation
  ...
  connect(QHea.y[2], mCal_flow.u) annotation (Line(points={{-119,70},{-100,70},{
          -100,10},{-82,10}}, color={0,0,127}));
  connect(coi.QOut_flow, add.u2) annotation (Line(points={{99,-31},{94,-31},{94,
          -16},{98,-16}}, color={0,0,127}));
  connect(coi.QLos_flow, add.u1) annotation (Line(points={{99,-34},{92,-34},{92,
          -4},{98,-4}}, color={0,0,127}));
  connect(add.y, plr.u) annotation (Line(points={{121,-10},{140,-10},{140,90},{50,
          90},{50,70},{58,70}}, color={0,0,127}));
  connect(plr.y, boi.y) annotation (Line(points={{81,70},{90,70},{90,58},{98,58}},
        color={0,0,127}));
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Boilers/Examples/SteamBoilerSimple1Loop_BS2021.mos"
        "Simulate and plot"));
end SteamBoilerSimple1Loop_BS2021;
