...
"Test model for the steam boiler with two fluid ports"
  ...
  Buildings.Fluid.FixedResistances.PressureDrop dp_wat(
  ...
  Buildings.Fluid.Sources.Boundary_pT watSou(
    ...
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  Buildings.Fluid.Boilers.SteamBoilerPolynomial boi(
    ...
    fue=Buildings.Fluid.Data.Fuels.NaturalGasLowerHeatingValue()) "Steam boiler"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Boilers/Examples/SteamBoilerPolynomial.mos"
        "Simulate and plot"));
end SteamBoilerPolynomial;
