...
equation
  connect(pum2.port_b, preDro.port_a) annotation (Line(points={{10,-20},{0,-20},
          {0,30},{10,30}},  color={0,127,255}));
  ...
  connect(m2_flow.y, pum2.m_flow_in)
    annotation (Line(points={{-17,0},{20,0},{20,-8}}, color={0,0,127}));
  connect(pum1.port_b, preDro.port_a) annotation (Line(points={{10,-60},{0,-60},
          {0,30},{10,30}},  color={0,127,255}));
  ...
  connect(y1.y, m1_flow.u) annotation (Line(points={{-59,-40},{-40,-40}},
                      color={0,0,127}));
  connect(m1_flow.y, pum1.m_flow_in)
    annotation (Line(points={{-17,-40},{20,-40},{20,-48}}, color={0,0,127}));
  connect(y2.y, pro.u1) annotation (Line(points={{-59,0},{-56,0},{-56,44},{-42,
          44}},
        color={0,0,127}));
  connect(y1.y, pro.u2) annotation (Line(points={{-59,-40},{-50,-40},{-50,32},{
          -42,32}},
                color={0,0,127}));
  connect(pro.y, boi.y)
    annotation (Line(points={{-19,38},{48,38}},         color={0,0,127}));
  connect(boi.port_b, coi2.port_a) annotation (Line(points={{70,30},{80,30},{80,
          -20},{70,-20}}, color={0,127,255}));
  connect(boi.port_b, coi1.port_a) annotation (Line(points={{70,30},{80,30},{80,
