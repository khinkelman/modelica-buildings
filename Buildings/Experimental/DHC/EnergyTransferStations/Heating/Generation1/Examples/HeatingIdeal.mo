within Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Examples;
model HeatingIdeal
  ...
  parameter Modelica.SIunits.SpecificEnthalpy dh_nominal=
    MediumSte.enthalpyOfVaporization(
      MediumSte.saturationState(pSte))
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.HeatingIdeal ets(
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Heating/Generation1/Examples/HeatingIdeal.mos"
        "Simulate and plot"));
end HeatingIdeal;
