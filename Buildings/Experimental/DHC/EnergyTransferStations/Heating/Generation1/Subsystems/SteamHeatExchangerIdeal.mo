within Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems;
model SteamHeatExchangerIdeal
  "Ideal model for a steam heat exchanger for district heating applications"
