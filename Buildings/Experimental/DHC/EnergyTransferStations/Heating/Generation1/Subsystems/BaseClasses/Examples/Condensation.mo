...
model Condensation
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems.BaseClasses.Condensation con(
  ...
  Buildings.Fluid.Sources.Boundary_pT watSin(redeclare package Medium = MediumWat,
  ...
  Modelica.Blocks.Sources.Constant pIn(k(start=1000000)=pSte_nominal)
                                                  "Steam pressure (Pa)"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Heating/Generation1/Subsystems/BaseClasses/Examples/Condensation.mos"
        "Simulate and plot"));
end Condensation;
