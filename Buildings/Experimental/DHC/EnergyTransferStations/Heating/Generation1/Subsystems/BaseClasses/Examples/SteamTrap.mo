within Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems.BaseClasses.Examples;
model SteamTrap
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems.BaseClasses.SteamTrap steTra(redeclare
  ...
  Buildings.Fluid.Sources.Boundary_pT sin(redeclare package Medium = MediumWat,
    p=pSat - dp,
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pum(redeclare package Medium = MediumWat,
      m_flow_nominal=m_flow_nominal,
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Heating/Generation1/Subsystems/BaseClasses/Examples/SteamTrap.mos"
        "Simulate and plot"));
end SteamTrap;
