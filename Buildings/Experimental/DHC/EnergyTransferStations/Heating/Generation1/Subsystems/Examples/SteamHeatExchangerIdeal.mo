within Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems.Examples;
model SteamHeatExchangerIdeal
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Heating.Generation1.Subsystems.SteamHeatExchangerIdeal hex(
  ...
  Buildings.Fluid.Sources.Boundary_pT sinWat(redeclare package Medium = MediumWat, nPorts=1)
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Heating/Generation1/Subsystems/Examples/SteamHeatExchangerIdeal.mos"
        "Simulate and plot"));
